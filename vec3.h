...
class vec3{
  ...
  //all functions outside dont modify left hand vec3 object, and maybe even modify right hand vec3 object too, or create new object
		...
		inline vec3 refract(const vec3& uv, const vec3& n, double etai_over_etat) {//unit incident vector, normal at point of intersection with surface and ratio of refractive index
